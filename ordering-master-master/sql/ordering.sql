...
DROP DATABASE IF EXISTS ordering_flowable;
CREATE DATABASE IF NOT EXISTS ordering_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用Ordering管理系统', '2017-01-11 08:53:20', '1');
