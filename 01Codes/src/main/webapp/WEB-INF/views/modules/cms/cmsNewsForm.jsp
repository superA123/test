...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/cmsNews/">新闻列表</a></li>
		<li class="active"><a href="#">新闻<shiro:hasPermission name="cms:cmsNews:edit">${not empty cmsNews.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:cmsNews:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsNews" action="${ctx}/cms/cmsNews/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="addtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${cmsNews.addtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="publisher" htmlEscape="false" maxlength="255" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
