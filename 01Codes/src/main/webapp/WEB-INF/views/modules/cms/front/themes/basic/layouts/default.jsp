...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${site.title} - Powered By Cd-JeeSite</title>
          ...
          <div class="nav-collapse">
            <ul id="main_nav" class="nav nav-pills">
			   ...
			   <!--  <li id="siteSwitch" class="dropdown">
			    ...
			    <!-- </li>--> 
<%-- 			    <li class="dropdown">
			       	<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="APP应用"><i class="icon-leaf"></i></a>
				    <ul class="dropdown-menu">
				      <li><img alt="APP二维码" src="${ctxStatic}/images/android.jpg" class="img-responsive"></li>
				      <li class="divider"></li>
				      <li><img alt="APP二维码" src="${ctxStatic}/images/ios.jpg" class="img-responsive"></li>
				    </ul>
			    </li>
--%>
            </ul>
	...
	<div class="container">
		...
		<footer>
			<div class="footer_nav"><a href="${ctx}/guestbook" target="_blank">公共留言</a> | <a href="${ctx}/search" target="_blank">全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" target="_blank">站点地图</a> | <a href="mailto:changziyu@126.com">技术支持</a> | <a href="${pageContext.request.contextPath}${fns:getAdminPath()}" target="_blank">后台管理</a></div>
