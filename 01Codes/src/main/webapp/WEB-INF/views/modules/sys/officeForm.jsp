...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">机构<shiro:hasPermission name="sys:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="8"/>
			</div>
		</div>
		<c:if test="${fns:getConfig('top.id') ne office.id}">
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="useable" class="input-large">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="address" htmlEscape="false" maxlength="25"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="master" htmlEscape="false" maxlength="5"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="fax" htmlEscape="false" maxlength="13"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">邮箱:</label>
			<div class="controls">
				<form:input path="email" htmlEscape="false" maxlength="25"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">备注:</label>
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="2" maxlength="50" class="input-large"/>
			</div>
		</div>
		</div>
