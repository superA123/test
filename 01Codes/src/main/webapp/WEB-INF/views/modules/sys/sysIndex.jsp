...
<body>
	<div id="main">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<c:if test="${fns:getConst('IS_PASS') eq false}">
							</c:if>
								<li class="divider"></li>
								<li><a href="${ctx}/sys/register/info?id=1000" target="mainFrame"><i class="icon-cog"></i>&nbsp; 系统信息</a></li>
								<li>
								<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=930712344&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:13844796:51" alt="在线帮助" title="在线帮助"/></a>
								</li>
						</ul>
					</li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="navbar-inner row-fluid text-center">
	            Copyright &copy; 2014-${fns:getConfig('copyrightYear')} <strong>幼儿园综合信息管理平台</strong> ${fns:getConfig('version')} - Powered By
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
