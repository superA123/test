...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">用户<shiro:hasPermission name="sys:user:edit">${not empty user.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:user:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="no" htmlEscape="false" maxlength="5"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="loginFlag" class="input-large" required="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="userType" class="input-large" required="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="email" htmlEscape="false" maxlength="25" class="email"/>
			</div>
		</div>
		<div class="control-group">
