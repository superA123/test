...
import com.cloud.jeesite.core.common.security.shiro.session.SessionDAO;
...
import com.cloud.jeesite.core.common.web.Servlets;
...
public class SystemService extends BaseService {
	...
	public static String entryptPassword(String plainPassword) {
		String password = new Md5Hash(plainPassword).toString();
		return password;
	}
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By 梦想创意工作室");
		sb.append("\r\n======================================================================\r\n");
